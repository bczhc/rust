...
pub fn integral_trapezoid_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
...
pub fn integral_left_rectangle_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
    F: Fn(T) -> Complex<T> + Copy + Sync + Send,
    T: Float + NumAssign + Send + Sync,
{
...
pub fn integral_right_rectangle_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
    F: Fn(T) -> Complex<T> + Copy + Sync + Send,
    T: Float + NumAssign + Send + Sync,
{
...
pub fn integral_simpson_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
    F: Fn(T) -> Complex<T> + Copy + Sync + Send,
    T: Float + NumAssign + Send + Sync,
{
...
pub fn integral_simpson_38_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
    F: Fn(T) -> Complex<T> + Copy + Sync + Send,
    T: Float + NumAssign + Send + Sync,
{
...
pub fn integral_boole_rayon<F, T>(segments: u32, x0: T, xn: T, function: F) -> Complex<T>
where
    F: Fn(T) -> Complex<T> + Copy + Sync + Send,
    T: Float + NumAssign + Send + Sync,
{
