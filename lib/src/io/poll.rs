use crate::io::errors::ErrnoResult;
use errno::Errno;
...
type Result<T> = ErrnoResult<T>;

pub fn poll_between_two_streams(stream1: &TcpStream, stream2: &TcpStream) -> Result<()> {
